...
@section('content')
    ...
    @include('templates.subviews.form-search', ['action' => route('roles.index')])

    @include('templates.subviews.form-action')

    @include('templates.subviews.breadcrumb', ['model' => 'Role', 'action' => 'Listar'])
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group" aria-label="Ações">
                                    <a href="{{ route('roles.show', $item->id) }}" title="Visualizar role" type="button" class="btn btn-info rounded-0"><i class="fa-solid fa-eye"></i></a>
                                    <button data-button-delete title="Excluir role" type="button" class="btn btn-danger rounded-0"><i class="fa-solid fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="container">
        <a title="adicionar Role" aria-label="adicionar Role" href="{{ route('roles.create')}}" class="btn btn-sm btn-primary rounded-0"> Adicionar <i class="fa-solid fa-plus"></i></a>
    </div>
